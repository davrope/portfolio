                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className='d-flex justify-content-center'>
                        <div className='form-group'>
                            ...
                            <input type = 'string' className='form-control' style={{height:'80px', textAlign:'center'}} id = 'message' aria-describedby="message" placeholder="Your idea" required/>
                    ...
                    {/* <div className='d-flex justify-content-center' >
                        <button type='button'  style={{marginTop: 100}}>
