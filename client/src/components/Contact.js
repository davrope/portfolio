   ...
   const [status, setStatus] = useState("Submit")
    ...
    return (
        <div id = 'contact' style={{background: 'black', height:'100vh', width:'100vw'}}>
            <div  style= {{margin: 0, position:'relative', top:'25%'}}>
                ...
                <form onSubmit={handleSubmit}>
                    <div className='d-flex justify-content-center'>
                        <div className='form-group'>
                            ...
                            <input type = 'text' className='form-control' id = 'name' style= {{textAlign:'center'}} aria-describedby="namehelp" placeholder="What's your name?" required/>
                        </div>
                    </div>
                    ...
                    <div className='d-flex justify-content-center'>
                        <div className='form-group'>
                            ...
                            <input type = 'email' className='form-control'  style= {{textAlign:'center'}} id = 'email' aria-describedby="emailHelp" placeholder="Enter email" required/>
                    ...
                    <div className='d-flex justify-content-center'>
                        <div className='form-group'>
                            ...
                            <textarea type = 'string' rows = "10" cols = "20" className='form-control' style={{height:'80px', textAlign:'center'}} id = 'message' aria-describedby="message" placeholder="Your idea" required/>
                    ...
                    <div className='d-flex justify-content-center' style={{marginTop: '15px'}} >
                        {/* <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
                            ...
                            <a href='https://twitter.com/davroper'/>
                        </svg>
                        ...
                        <a className='item' href='https://twitter.com/davroper' style={{marginLeft: '10px', marginRight: '10px'}}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#fff" class="bi bi-twitter" viewBox="0 0 16 16">
                                <path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z"/>                               
                            </svg>
                        </a>

                        <a className='item' href='https://www.instagram.com/david_rp/'>
